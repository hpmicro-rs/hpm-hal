// NOTE: this is almost the same as v63, but default AHB and AXI clocks are different
...
const CLK_AXI: Hertz = Hertz(400_000_000 / 2); // CLK_CPU0 / 2
const CLK_AHB: Hertz = Hertz(400_000_000 / 2); // CLK_CPU0 / 2
